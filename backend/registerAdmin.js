...
async function registerAdminUser() {
    try {
        ...
        if (userExists) {
            console.log(`An identity for the user ${adminId} already exists in the wallet`);
            return;
        }
        ...
        console.log(`Successfully registered user ${adminId} with enrollment secret ${enrollmentSecret}`);
